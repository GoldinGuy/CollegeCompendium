...
import { BookLoader, TextbookGallery } from "../components";
...
const TextbookPage = ({
	...
	return (
		<div className="container relative flex flex-col justify-between h-full max-w-6xl sm:px-8 mx-auto xl:px-0 overflow-x-hidden">
			<h2 className="pb-6 mb-1 text-center congress text-2xl font-extrabold leading-tight px-2 text-gray-900 md:text-4xl">
				View Free Public CS Textbooks
			</h2>
			...
			<div className="relative flex items-center self-start sm:mb-1 mt-2 font-black w-full">
				{loading ? (
					...
					>
						...
						<div className="flex flex-col">
							{TEXTBOOK_TAGS.map((category, i) => {
								return (
									<div id={category} className="mt-4 px-10">
					...
					<div className="flex flex-col">
						{TEXTBOOK_TAGS.map((category, i) => {
							return (
								<div id={category} className="mt-4 px-4 sm:px-10">
